...
public class PteranodonsBaby extends Dinosaurs {
	 ...
	 * @param hitPoints
	 */
	public PteranodonsBaby(String name, char displayChar, int hitPoints) {
		...
		actions.add(new SellAliveDinosaurs(this,7500));
	...
	public Action playTurn(Actions actions, Action lastAction, GameMap map, Display display) {
		...
		if(this.dinoAge == 20){
			...
			map.addActor(new Pteranodons("Pteranodons"), here);
			return new DoNothingAction();
		}
