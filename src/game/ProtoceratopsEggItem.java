...
public class ProtoceratopsEggItem extends PortableDinoItem {
	 ...
	 * @param name
	 */
	public ProtoceratopsEggItem(String name) {
		super(name, 'o');
		this.addSkill(Status.PROEGG);
		addSkill(Status.EGG);
	...
	public void tick(Location currentLocation){
		...
		if (eggAge == 10 && !currentLocation.containsAnActor()){
			...
			currentLocation.addActor(new ProtoceratopsBaby("BabyPro",'p',100));
