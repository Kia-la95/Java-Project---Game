...
/**
 *this is action to buy velociraptors Egg for $1000.
 */
public class BuyVelociraptorsEggAction extends Action {

	private int price = 1000;
	private VelociraptorsEggItem egg = new VelociraptorsEggItem("egg");
	
	public BuyVelociraptorsEggAction(VelociraptorsEggItem egg){
		this.egg = egg;
